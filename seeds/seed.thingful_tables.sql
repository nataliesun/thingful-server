BEGIN;
  ...
  VALUES
    ('dunder', 'Dunder Mifflin', null, '$2a$12$pWdyP7b8QT0lifixOq46/OnqU0rkIGN40W1SGU/Vtg227p/um5xvC'),
    ('b.deboop', 'Bodeep Deboop', 'Bo', '$2a$12$SCfOuxmu/ojGGYEBYI3ffuiL7c3wcEKsUr0XFJI0HFJtyI4AjmysG'),
    ('c.bloggs', 'Charlie Bloggs', 'Charlie', '$2a$12$kKZsbpYrgJX5VFh441Seauhm5jyR2BiEVwtFojkIqcZnIzgq3gjr.'),
    ('s.smith', 'Sam Smith', 'Sam', '$2a$12$E6Hjnb5LAs0pgNoL2hG5w.l4SyOeSQLvnfo9XJ037thKNlL2IUaBq'),
    ('lexlor', 'Alex Taylor', 'Lex', '$2a$12$Udla8nLnCR04aCKJXbmfVuUkW0D5NOd9WnJ2wGvPfjKqy7rfkYk8u'),
    ('wippy', 'Ping Won In', 'Ping', '$2a$12$kZ8EAoj.MQXxNVOzz1JAke8RpiEY9nqETIlJFXXpLj01irPLPawDi');
